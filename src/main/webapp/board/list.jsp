...
<main class="container main-content">
    ...
    <div class="community-hero">
        ...
        <h1 style="color:#3d3d3d;">팬들과 함께 만드는<br><span style="color:red;">KICK-OFF 게시판</span></h1>
        <p style="color: black;">K-리그 팬들과 자유롭게 소통하고<br>경기 이야기와 다양한 의견을 나누는 공간입니다.</p>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h2 class="board-title mb-1">자유게시판</h2>
            <p class="board-sub mb-0">팬들과 경기 정보와 다양한 이야기를 공유해보세요.</p>
        </div>
                ...
                <tbody>
                    ...
                    <c:forEach var="vo" items="${list}">
                        <tr class="dataTr">
                            ...
                            <td>
                                <a href="../board/detail.do?no=${vo.no}" class="board-link">${vo.title}</a>
