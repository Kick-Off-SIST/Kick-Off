    ...
    <div class="card board-card">
        ...
        <div class="card-body p-4">
			...
			<c:if test="${reply != null}">
			    <div class="mt-4 p-4" style="background:#f0fdf4; border:1px solid #bbf7d0; border-radius:8px;">
			        <h6 class="fw-bold text-success">💬 관리자 답변</h6>
			        <p class="text-muted small mb-2">${reply.dbday}</p>
			        <pre style="white-space:pre-wrap; background:transparent; border:none; padding:0;">${reply.content}</pre>
			    </div>
			</c:if>
            <div class="board-actions d-flex justify-content-end gap-2 mt-4">

                <a href="../qna/update.do?no=${vo.no}"
